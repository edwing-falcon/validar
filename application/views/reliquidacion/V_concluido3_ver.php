    ...
    <div class="main-content-inner">
        <div class="page-content">
           <div class="page-header">
                <h1>FORMULARIO M-03 VALIDADO</h1><br/>
                <h1>
                ...
                <div class="col-xs-12">
                    <div class="row">
                        <div class="col-xs-12">
                            ...
                            <div style="background-color:#9630B9; color:#FFF; font-size:14px; line-height:20px; padding-left:12px; margin-bottom:1px;" > 1. DATOS DEL EXPLORADOR</div>
                            <div>
                            ...
                            <div style="background-color:#9630B9; color:#FFF; font-size:14px; line-height:20px; padding-left:12px; margin-bottom:1px;" > 2. DATOS DEL COMPRADOR</div>
                            <div>
                                <table class="table table-bordered">
                                    <thead>
                                        <tr>
                            ...
                            <div style="background-color:#9630B9; color:#FFF; font-size:14px; line-height:20px; padding-left:12px; margin-bottom:1px;" > 3. CARACTERISTICAS DEL MINERAL COMERCIALIZADO</div>
                            <div>
                                <table class="table table-bordered">
                                    <thead>
                                        <tr>
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <?php if($form->humedad == 0):?>
                                                <td style="text-align: center; background: #FA522E"><?php echo number_format($form->humedad, 2);?></td>
                                            <?php else: ?>
                            ...
                            <div style="background-color:#9630B9; color:#FFF; font-size:14px; line-height:20px; padding-left:12px; margin-bottom:1px;" > 4. VALOR OFICIAL (REGALIA MINERA)</div>
                            <div>
                            ...
                            <div style="background-color:#9630B9; color:#FFF; font-size:14px; line-height:20px; padding-left:12px; margin-bottom:1px;" > 5. TRANSACCION INTERNA (SI CORRESPONDE)</div>
                            <div>
                                <table class="table table-bordered">
                                    <thead>
                                        <tr>
                            ...
                            <div style="background-color:#9630B9; color:#FFF; font-size:14px; line-height:20px; padding-left:12px; margin-bottom:1px;" > 6. APORTE DEPARTAMENTAL Y MUNICIPAL</div>
                            <div>
                            ...
                            <div style="background-color:#9630B9; color:#FFF; font-size:14px; line-height:20px; padding-left:12px; margin-bottom:1px;" > 7. APORTES INSTITUCIONALES</div>
                            <div>
                            ...
                            <br/>
                            <br/>
                            <!--<div style="background-color:#9630B9; color:#FFF; font-size:14px; line-height:20px; padding-left:12px; margin-bottom:1px;" > LOS DATOS DEL PRESENTE FORMULARIO</div>
