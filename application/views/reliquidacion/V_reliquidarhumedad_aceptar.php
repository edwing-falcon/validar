    ...
    <div class="main-content-inner">
        <div class="page-content">
            <div class="page-header">
                <h1>FORMULARIO M-03 PARA SU RELIQUIDACION POR HUMEDAD</h1><br/>
                <h1>
                    ID M-03: <?php echo $id;?>
                    <small>
                ...
                <div class="col-xs-12">
                    <div class="row">
                        <div class="col-xs-12">
                                ...
                                <table class="table table-bordered">
                                    <thead>
                                        <tr>
                                            ...
                                            <th style="text-align: center">FECHA VENCIMIENTO HUMEDAD</th>
                                            ...
                                            <th style="text-align: center">FECHA DE RELIQUIDACION POR HUMEDAD</th>
                                        </tr>
                                    </thead>
                                    <tbody>
                                        <tr>
                                            <td style="text-align: center"><?php echo $fechavalidacion;?></td>
                                            <td style="text-align: center"><?php echo $fechavencimientohumedad;?></td>
                            ...
                            <div class="row">
                                <div class="col-xs-12">
                                    <form class="form-horizontal" role="form" method="POST" name="formreliquidar" action="<?php echo base_url();?>C_muestreoReliquidacion/aceptar_humedad/<?php echo $this->Formm03_model->encriptar($id);?>">
                                        <table border="0" cellspacing="30" cellpadding="30" align="center">
                                            <tr>
                                                <td>Fecha de Informe de Laboratorio: </td>
                                                <td>
                                                    <?php if($fechainformelaboratorio): ?>
                                                        <input type="date" name="fechainformelaboratorio" value="<?php echo $fechainformelaboratorio; ?>">
                                                    <?php else: ?>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <?php if($numinformelaboratorio): ?>
                                                        <input type="text" name="numinformelaboratorio" maxlength="50" value="<?php echo $numinformelaboratorio; ?>">
                                                    <?php else: ?>
