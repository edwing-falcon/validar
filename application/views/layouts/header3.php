...
<html lang="es">
    <head>
        ...
        <!--para uploads-->
        <script src="<?= base_url() ?>combos/jquery.min_1.js"></script>
        <script src="<?= base_url()?>combos/fileinput.js"></script>
        <link  href="<?= base_url()?>combos/fileinput.css" rel="stylesheet">
                                ...
                                <!--<li class="dropdown-content">
                                    <ul class="dropdown-menu dropdown-navbar">
                                        <li>
                                            <a href="#">
                                                <div class="clearfix">
                                                    <span class="pull-left">Pendientes</span>
                                        ...
                                        <li>
                                            <a href="#">
                                                <div class="clearfix">
                                                    <span class="pull-left">Rechazados</span>
