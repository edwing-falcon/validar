...
<div class="main-content"> 
    <div class="main-content-inner">
        <div class="page-content">
           <div class="page-header">
               <h1>VALIDAR FORMULARIO M-03</h1><br/>
                <h1>
                ...
                <div class="col-xs-12">
                    <div class="row">
                        <div class="col-xs-12">
                            ...
                            <br/>
                            <br/>
                            <div style="background-color:#D67E31; color:#FFF; font-size:14px; line-height:20px; padding-left:12px; margin-bottom:1px;" > LOS DATOS DEL PRESENTE FORMULARIO SON CORRECTOS</div>
                                ...
                                <div class="row">
                                    <div class="col-sm-5">
                                        <div class="widget-box">
                                            ...
                                            <form class="form-horizontal" role="form" method="POST" name="formvalidar" action="<?php echo base_url();?>C_recepcion3/guardar" >
                                                <br/>
                                                <input type="hidden" name="idformm03" value="<?php echo $id; ?>" />
                                                <div class="row">
                                                    ...
                                                    <div class="col-xs-6">
                                                        ...
                                                        <!--<a href="#" data-toggle="modal" data-target="#relacionadorm03m02" class="btn btn-primary btn-block" onclick="carga_tabla(<?php echo $id;?>, 'modal')">Validar</a>-->
                                                        <a href="<?php echo base_url()?>C_recepcion3/relacionadorm03m02_ver/<?php echo $this->Formm03_model->encriptar($id);?>" class="btn btn-primary btn-block">Validar</a>
                                                    </div>
                                                </div>   
                                                <hr />
                                                <div class="row">
    ...
    <div class="modal fade" id="relacionadorm03m02" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                    <center><h4 class="modal-title" id="myModalLabel"><b>RELACION DE M02 PARA VALIDAR M03</b></h4></center>
                    <br/><p>Debe introducir ID de formularios M02 que Respaldan la validacion del M03 con ID: <?php echo $id?></p>
                </div>
                ...
                <div class="modal-footer">
                    <center><button type="button" class="btn btn-primary" data-dismiss="modal">CONTINUAR CON LA VALIDACION</button></center>
                </div>
            </div>
        </div>
    </div>
     ...
     <script type="text/javascript">
        function carga_tabla(id){
            $('#tabla').load('<?php echo base_url(); ?>C_recepcion3/relacionadorM03M02/'+id);
