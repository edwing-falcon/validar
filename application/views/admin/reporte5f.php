                                            ...
                                            <div class="widget-box">
                                                    <div class="widget-header widget-header-flat widget-header-small">
                                                            <h5 class="widget-title">
                                                                    ...
                                                                    Datos Nacional -  Gestion <?= $gestion ?>
                                                            </h5>
    ...
    <div class="col-sm-4 infobox-container">
                        ...
                        <div class="infobox infobox-green infobox-small infobox-dark">
                                ...
                                <div class="infobox-data">
                                        <div class="infobox-content"><?php echo $totalValidador[0]->cantidad ?></div>
                                        <div class="infobox-content">Validado</div>
                                </div>
                        </div>

                        <div class="infobox infobox-red infobox-small infobox-dark">
                                <div class="infobox-chart">
                                        <span class="sparkline" data-values="3,4,2,3,4,4,2,2">M02</span>
                                </div>

                                <div class="infobox-data">
                                        <div class="infobox-content"><?php echo $totalValidador[1]->cantidad ?></div>
                                        <div class="infobox-content">Rechazado</div>
                                </div>
                        </div>
     ...
     <div class="col-sm-12 ">
                <div class="widget-box ">
                        <div class="widget-header widget-header-flat">
                                <h4 class="widget-title lighter">
                                        <i class="ace-icon fa fa-signal"></i>
                                        Validadores <?= $gestion1 ?> - Formulario M02
                                </h4>
...
<tbody>
        <?php
        if(isset($cuadroData5)){
        $nro=1;
        $datosTabla= '';
        foreach($cuadroData5 as $value)
        {
        $datosTabla = $datosTabla. "<tr>
        <td class='center'>".$nro++."</td>
        <td>".$value->departamento."</td>    
