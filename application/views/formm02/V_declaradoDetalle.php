                ...
                <div class="col-xs-12">
                    <div class="row">
                        <div class="col-xs-12">
                            ...
                            <div class="row">
                                <?php echo form_open('C_declaradoDetalle/busqueda'); ?>
                                    <div class="col-xs-1"></div>
                                    <div class="col-xs-2">
                                        <div class="input-group">
                                            <?php if ($this->session->userdata("idM02DeclaradoDetalle")) {
                                                echo form_label ('Ingrese un ID: ', 'idM02DeclaradoDetalle');
                                                echo form_input(["type" => "text", "name" => "idM02DeclaradoDetalle", "class" => "form-control search-query", "placeholder" => "", "value" => $this->session->userdata("idM02DeclaradoDetalle")]);
                                            } else {
                                                echo form_label ('Ingrese un ID: ', 'idM02DeclaradoDetalle');
                                                echo form_input(["type" => "text", "name" => "idM02DeclaradoDetalle", "class" => "form-control search-query", "placeholder" => ""]); 
                                            } ?>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-xs-2">
                                        <div class="input-group">
                                            <?php if ($this->session->userdata("vendedorM02DeclaradoDetalle")) {
                                                echo form_label ('Vendedor: ', 'vendedorM02DeclaradoDetalle');
                                                echo form_input(["type" => "text", "name" => "vendedorM02DeclaradoDetalle", "class" => "form-control search-query", "placeholder" => "", "value" => $this->session->userdata("vendedorM02DeclaradoDetalle")]);
                                            } else {
                                                echo form_label ('Vendedor: ', 'vendedorM02Declarado');
                                                echo form_input(["type" => "text", "name" => "vendedorM02DeclaradoDetalle", "class" => "form-control search-query", "placeholder" => ""]); 
                                            } ?>
                                        </div>
                                    </div>
                            </div>
                            <div class="row">
                                ...
                                <?php echo form_close(); ?>
                                        <div class="col-xs-2">
                                            <?php echo form_open('C_declaradoDetalle/mostrar');?>
