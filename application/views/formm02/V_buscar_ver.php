<?php 
    ...
    $cod = $codigos;
    $estado = $estados;
    $oficinavalidacion = $oficinavalidacions;
    $estadorevision = $estadorevisions;
?>
    ...
    <div class="main-content-inner">
        <div class="page-content">
           <div class="page-header">
                <h1>FORMULARIO M-02</h1><br/>
                <h1>
                    ID: <?php echo $id;?>         CODIGO: <?php echo $cod;?> 
                    <small>
                        <i class="ace-icon fa fa-angle-double-right"></i>
                        CON ESTADO: <?php echo $estado;?> &nbsp; DEPARTAMENTAL: <?php echo $oficinavalidacion;?>
                        <?php if(strlen($estadorevision) > 0):?>
                            ESTADO REVISION: SUJETO A REVISION
                        <?php else: ?>
                ...
                <div class="col-xs-12">
                    <div class="row">
                        <div class="col-xs-12">
                            ...
                            <br/>
                            <br/>
                            <div class="table-header"> LOS DATOS DEL PRESENTE FORMULARIO</div>
                            <div>
                                <br/>
                                <div class="row">
                                    <div class="col-sm-7">
