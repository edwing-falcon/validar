...
<div class="content-wrapper">
    ...
    <section class="content">
        ...
        <div class="row">
            ...
            <div class="col-xs-2">
                <a href="<?php echo base_url()?>formulario_m02/C_formm02_declarados/edit/<?php echo $id;?>" class="btn btn-block btn-primary btn-lg"><span class="fa fa-floppy-o"></span> Finalizar (Guardar)</a>
            </div>
            
            <div class="col-xs-2">
                <a href="<?php echo base_url()?>formulario_m02/C_formm02_declarados/edit/<?php echo $id;?>" class="btn btn-block btn-success btn-lg"><span class="fa  fa-paperclip"></span> Prueba</a>
            </div>
            
            <div class="col-xs-2">
                <a href="<?php echo base_url()?>formulario_m02/C_formm02_declarados/edit/<?php echo $id;?>" class="btn btn-block btn-danger btn-lg"><span class="fa fa-close"></span> Cancelar</a>
            </div>
        </div>
    </section>
</div>
