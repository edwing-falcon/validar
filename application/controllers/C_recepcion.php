...
class C_recepcion extends CI_Controller {
    ...
    public function index($nropagina = FALSE){
        ...
        $conta = $this->Formm02_model->getTotal(1, $idM02recepcion, $compradorM02Recepcion, $vendedorM02Recepcion);
        ...
        $data = array(
            "recepciones" => $this->Formm02_model->getRecepcion($idM02recepcion, $compradorM02Recepcion, $vendedorM02Recepcion, $inicio, $mostrarpor),
            "cants" => $cant
        );
        ...
        $this->load->view("formm02/V_recepcion",$data);
