...
//    }
    ...
    public function index(){
            ...
            // ***** USUARIO GERENCIAL O AUTORIDADES_EXTERNO **********************// 
            if($idrol == 14 || $idrol == 10 )
            {
                 ...
                 $data['totalM02']   = $this->ReporteGrafico_model->totales($gestion, 'formm02');
                 $data['totalM03']   = $this->ReporteGrafico_model->totales($gestion, 'formm03');
                 
                $temp = $this->ReporteGrafico_model->validadorParaGerenciaHoy('formm02');
                $data['chartDataVM02Hoy']    = $this->convertirJson4($temp);
                //$data['cuadroDataVM02Hoy']   = $temp;
                
                $temp = $this->ReporteGrafico_model->validadorParaGerenciaHoy('formm03');
                $data['chartDataVM03Hoy']    = $this->convertirJson4($temp);
                //$data['cuadroDataVM03Hoy']   = $temp;
...
//                $data['cuadroDataM03']   = $this->ReporteGrafico_model->datosParaCuadroOnLine($departamento,$gestion, 'formm03');
                ...
                // *** validadores a nivel nacional *********************************
                $temp = $this->ReporteGrafico_model->validadorPorDpto($departamento,$gestion, 'formm02');
                $data['chartDataVM02']    = $this->convertirJson3($temp);
                $data['cuadroDataVM02']   = $temp;
                
                $temp = $this->ReporteGrafico_model->validadorPorDpto($departamento,$gestion, 'formm03');
                $data['chartDataVM03']    = $this->convertirJson3($temp);
                $data['cuadroDataVM03']   = $temp;
                ...
                $temp = $this->ReporteGrafico_model->validadorPorDptoHoy($departamento, 'formm02');
                $data['chartDataVM02Hoy']    = $this->convertirJson3($temp);
                //$data['cuadroDataVM02Hoy']   = $temp;
                
                $temp = $this->ReporteGrafico_model->validadorPorDptoHoy($departamento, 'formm03');
                $data['chartDataVM03Hoy']    = $this->convertirJson3($temp);
                //$data['cuadroDataVM03Hoy']   = $temp;
            ...
            if ( ($idrol == 14  || $idrol == 10 )  && $login == true)
             {
